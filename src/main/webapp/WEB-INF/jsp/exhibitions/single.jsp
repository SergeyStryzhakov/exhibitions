            ...
            <div class="row align-items-stretch">
                <div class="col-md-7" data-aos="fade-up">
                    ...
                    <ul class="list-unstyled list-line mb-5">
                        ...
                        <li><fmt:message key="exhibition.state"/>: ${ex.state}</li>
                    </ul>
                ...
                <div class="col-md-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
                    <div class="sticky-content">
                        <c:choose>
                            <c:when test="${ex.state != 'ACTIVE'}">
                                <h4 class="h3 mb-3 text-center text-danger">
                                    <fmt:message key="exhibition.message.notavailable"/>
                                </h4>
                            </c:when>
                            <c:otherwise>
                                ...
                                <c:forEach var="hall" items="${ex.halls}">
                                    <form class="border border-primary m-3 p-3"
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <p class="text-primary text-center"><fmt:message
                                                        key="single.needlogin"/></p>
                                            </c:otherwise>
                                        </c:choose>
                                    </form>
                                </c:forEach>
