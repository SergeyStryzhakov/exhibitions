...
<div class="container">
    <div class="row mb-5 align-items-end">
        <div class="col-md-6" data-aos="fade-up">
            <h2><fmt:message key="halls.manage.create"/></h2>
        </div>
    </div>
    <div class="row">
            ...
            <form action="create" method="post" role="form">
                <div class="row gy-3">
                    <div class="col-md-12 form-group">
                        <label for="name"><fmt:message key="halls.manage.name"/></label>
                        <input type="text" name="name" class="form-control" id="name" required>
                    </div>
                    <div class="col-md-12 form-group">
                        <label for="address"><fmt:message key="halls.manage.address"/></label>
                        <input type="text" name="address" class="form-control" id="address" required>
                    </div>
                    <div class="col-md-12 form-group">
                        <label for="capacity"><fmt:message key="halls.manage.capacity"/></label>
